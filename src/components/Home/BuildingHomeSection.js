                        ...
                        <div className="building-home-section-text-container">
                            ...
                            <FramerTextReveal delay={0.35}>
                                <p className="building-home-section-description">
                                    From the moment you arrive, AQUA commands attention, where striking architecture meets timeless design. Crafted with meticulous detail, every corner reflects an uncompromising commitment to quality and refined urban living.
                                </p>
                            </FramerTextReveal>
